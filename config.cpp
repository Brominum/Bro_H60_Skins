...
class CfgVehicles
{
	...
	class vtx_H60_base: Heli_Transport_01_base_F
	{
		class textureSources
		{
			...
			class Bro_RedYellow
			{
				displayName = "[Bro] Red/Yellow Stripes";
				author = "Bromine";
				textures[] = {
					"",
					"",
			...
			class Bro_BlueWhite
			{
				displayName = "[Bro] Blue/White Stripes";
				author = "Bromine";
				textures[] = {
					"",
					"",
			...
			class Bro_MT
			{
				displayName = "[Bro] Missing Texture";
				author = "Bromine";
				textures[] = {
					"",
					"",
